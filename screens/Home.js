...
const Home = ({ navigation }) => {
  ...
  const bookAriDante = {
    id: 2,
    bookName: "Aristotle and Dante",
    bookCover: images.ariDante,
    rating: 4.3,
    language: "Eng",
    pageNo: 359,
    ...
    backgroundColor: "rgba(47, 83, 105, 0.9)",
    navTintColor: "#FFF",
  };

  const bookBlackTides = {
    id: 3,
    bookName: "The Black Tides of Heaven",
    bookCover: images.blackTides,
    rating: 3.7,
    language: "Eng",
    pageNo: 236,
    author: "Neon Yang",
    ...
    backgroundColor: "rgba(1, 47, 99, 0.9)",
    navTintColor: "#FFF",
  };

  const bookOathbringer = {
    id: 4,
    bookName: "Oathbringer",
    bookCover: images.oathbringer,
    rating: 4.5,
    language: "Eng",
    pageNo: 1248,
  ...
  const categoriesData = [
    {
      ...
      books: [bookOtherWordsForHome, bookOathbringer, bookTheTinyDragon],
    },
    {
      id: 2,
      categoryName: "The Latest",
      books: [bookAriDante, bookOathbringer],
    },
    {
      id: 3,
      categoryName: "Coming Soon",
      books: [bookBlackTides],
    },
  ];
      ...
      return (
        ...
        >
          ...
          >
            ...
            />
            <Text
              style={{ marginLeft: 8, ...FONTS.body3, color: COLORS.lightGray }}
            >
              {item.lastRead}
            </Text>
